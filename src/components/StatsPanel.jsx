    ...
    return (
        <div
            ...
            style={{
                ...
                overflow: "auto",
                animation:
                    "slideInLeft 400ms cubic-bezier(0.32, 0.72, 0, 1) forwards"
            }}
        >
            <div style={{position: "relative", zIndex: 2}}>
                ...
                <StatBlock
                    icon={Route}
                    label="BUS ROUTES"
                    value={stats.busRoutes}
                    delay={200}
                    color="var(--text-secondary)"
                />
                <StatBlock
                    icon={AlertTriangle}
                    label="LAST-MILE GAP ZONES"
                    value={stats.gapZones}
                    delay={300}
                    color="var(--danger)"
                />
                ...
                >
                    ...
                    >
                        ...
                        >
                            {isSimulated ? "SIMULATED BUSES" : "LIVE BUSES"}
                        </span>
                    </div>
                    <span className="stat-number" style={{fontSize: 20}}>
                        {stats.liveBuses > 0
                            ? stats.liveBuses.toLocaleString()
                            : "—"}
                    </span>
                    <span
                        style={{
