...
function App() {
    ...
    const [busSimulated, setBusSimulated] = useState(true);

    useEffect(() => {
        const d = loadData();
        setData(d);
        const hexes = computeHexagons(
            d.metroStations,
            d.busStops,
            d.busFrequency
        );
        ...
        return (
            ...
            >
                <div style={{textAlign: "center"}}>
                    ...
                    <div
                        className="skeleton"
                        style={{width: 140, height: 14, margin: "0 auto"}}
                    />
                </div>
            </div>
        );
    ...
    return (
        ...
        >
            <Map
                ...
                onBusUpdate={(count, isSimulated) => {
                    setLiveBusCount(count);
                    setLastBusUpdate(new Date());
                    setBusSimulated(isSimulated);
                }}
            />
            <Header
